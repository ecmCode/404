...
function NotFound() {
    ...
    return(
        <div className='w-screen h-screen overflow-hidden flex flex-col gap-10 justify-center items-center bg-gradient-to-tr from-primary to-secondary text-white relative'>
            ...
            {/* Main Article */}
            <div className='flex flex-col md:flex-row justify-center items-center gap-6 z-10 mx-10 md:mx-32 animate-fadein-fast'>
                <h2 className='text-center md:text-left px-10 '>
                    <span className="text-8xl animate-pulse">404</span><br/>
                    Not Found.
                </h2> 
                <div className='flex flex-col justify-center items-center md:items-end gap-10 animate-fadein-slow'>
                    ...
                    <button className='bg-title drop-shadow-lg rounded px-48 md:px-10 py-4 text-xl'>Home</button>
                </div>
            </div>
        </div>
    )
